...
export function listExadataServices(params: ListExadataParams = {}) {
...
export function listAdditionalServices(params: ListAdditionalServicesParams = {}) {
