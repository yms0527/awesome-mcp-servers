...
#
package WWW::OpenAPIClient::Object::SearchResponse;
...
__PACKAGE__->method_documentation({
    'sorting' => {
        datatype => 'SearchResponseSorting',
        base_name => 'sorting',
        description => '',
        format => '',
        read_only => '',
    ...
    'active_filter_options' => {
        datatype => 'ARRAY[SearchResponseActiveFilterOptionsInner]',
    ...
    'results' => {
        datatype => 'ARRAY[SearchResponseResultsInner]',
        base_name => 'results',
        description => '',
        format => '',
        read_only => '',
    ...
    'filter_options' => {
        datatype => 'ARRAY[SearchResponseFilterOptionsInner]',
    ...
    'sorting_options' => {
        datatype => 'ARRAY[SearchResponseSortingOptionsInner]',
