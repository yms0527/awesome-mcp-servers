...
class GameResponseOffersInner(BaseModel):
    """
    GameResponseOffersInner
    """ # noqa: E501
    price: Optional[GameResponseOffersInnerPrice] = None
    store_name: Optional[StrictStr] = None
    platform: Optional[StrictStr] = None
    title: Optional[StrictStr] = None
    url: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["price", "store_name", "platform", "title", "url"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "price": GameResponseOffersInnerPrice.from_dict(obj["price"]) if obj.get("price") is not None else None,
