...
class SearchSuggestionResponse(BaseModel):
    ...
    """ # noqa: E501
    results: Optional[Annotated[List[SearchSuggestionResponseResultsInner], Field(max_length=100)]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results": [SearchSuggestionResponseResultsInner.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
        return _obj
