...
#   filename:  certificate_schema.json
#   timestamp: 2025-08-03T16:40:06+00:00
...
class Jks(BaseModel):
    ...
    passwordSecretRef: Optional[PasswordSecretRef] = Field(
        None,
...
class Excluded(BaseModel):
    dnsDomains: Optional[list[str]] = Field(
        None,
    ...
    uriDomains: Optional[list[str]] = Field(
        None,
...
class NameConstraints(BaseModel):
    critical: Optional[bool] = Field(
        None, description='if true then the name constraints are marked critical.'
    )
    excluded: Optional[Excluded] = Field(
        None,
        description='Excluded contains the constraints which must be disallowed. Any name matching a\nrestriction in the excluded field is invalid regardless\nof information appearing in the permitted',
    )
    permitted: Optional[Permitted] = Field(
        None,
...
class PrivateKey(BaseModel):
    ...
    rotationPolicy: Optional[RotationPolicy] = Field(
        None,
...
class Subject(BaseModel):
    countries: Optional[list[str]] = Field(
        None, description='Countries to be used on the Certificate.'
    )
    localities: Optional[list[str]] = Field(
        None, description='Cities to be used on the Certificate.'
    )
    organizationalUnits: Optional[list[str]] = Field(
        None, description='Organizational Units to be used on the Certificate.'
    )
    organizations: Optional[list[str]] = Field(
        None, description='Organizations to be used on the Certificate.'
    )
    postalCodes: Optional[list[str]] = Field(
        None, description='Postal codes to be used on the Certificate.'
    )
    provinces: Optional[list[str]] = Field(
        None, description='State/Provinces to be used on the Certificate.'
    )
    serialNumber: Optional[str] = Field(
        None, description='Serial number to be used on the Certificate.'
    )
    streetAddresses: Optional[list[str]] = Field(
        None, description='Street addresses to be used on the Certificate.'
    )
...
class Spec(BaseModel):
    additionalOutputFormats: Optional[list[AdditionalOutputFormat]] = Field(
        None,
    ...
    dnsNames: Optional[list[str]] = Field(
        None, description='Requested DNS subject alternative names.'
    )
    ...
    emailAddresses: Optional[list[str]] = Field(
        None, description='Requested email subject alternative names.'
    )
    encodeUsagesInRequest: Optional[bool] = Field(
        None,
    ...
    ipAddresses: Optional[list[str]] = Field(
        None, description='Requested IP address subject alternative names.'
    )
    ...
    keystores: Optional[Keystores] = Field(
        None,
        description="Additional keystore output formats to be stored in the Certificate's Secret.",
    )
    literalSubject: Optional[str] = Field(
        None,
    ...
    nameConstraints: Optional[NameConstraints] = Field(
        None,
    ...
    otherNames: Optional[list[OtherName]] = Field(
        None,
    ...
    renewBeforePercentage: Optional[int] = Field(
        None,
    ...
    secretTemplate: Optional[SecretTemplate] = Field(
        None,
    ...
    uris: Optional[list[str]] = Field(
        None, description='Requested URI subject alternative names.'
    )
...
class Status(BaseModel):
    ...
    failedIssuanceAttempts: Optional[int] = Field(
        None,
    ...
    renewalTime: Optional[datetime] = Field(
        None,
