...
#   filename:  issuer_schema.json
#   timestamp: 2025-08-03T16:40:10+00:00
...
class ExternalAccountBinding(BaseModel):
    ...
    keySecretRef: KeySecretRef = Field(
        ...,
...
class Acme(BaseModel):
    ...
    disableAccountKeyGeneration: Optional[bool] = Field(
        None,
    ...
    privateKeySecretRef: PrivateKeySecretRef = Field(
        ...,
    ...
    skipTLSVerify: Optional[bool] = Field(
        None,
    ...
    solvers: Optional[list[Solver]] = Field(
        None,
...
class Ca(BaseModel):
    ...
    issuingCertificateURLs: Optional[list[str]] = Field(
        None,
    ...
    ocspServers: Optional[list[str]] = Field(
        None,
...
class Kubernetes1(BaseModel):
    ...
    serviceAccountRef: Optional[ServiceAccountRef1] = Field(
        None,
...
class Cloud(BaseModel):
    apiTokenSecretRef: ApiTokenSecretRef = Field(
        ...,
...
class Tpp(BaseModel):
    ...
    credentialsRef: CredentialsRef = Field(
        ...,
...
class Issuer(BaseModel):
    ...
    spec: Spec = Field(..., description='Desired state of the Issuer resource.')
    status: Optional[Status] = Field(
        None, description='Status of the Issuer. This is set and managed automatically.'
    )
