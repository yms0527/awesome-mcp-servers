...
class SearchResponseActiveFilterOptionsInner(BaseModel):
    """
    SearchResponseActiveFilterOptionsInner
    """ # noqa: E501
    key: Optional[StrictStr] = None
    connection: Optional[StrictStr] = None
    values: Optional[Annotated[List[SearchResponseActiveFilterOptionsInnerValuesInner], Field(max_length=100)]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "values": [SearchResponseActiveFilterOptionsInnerValuesInner.from_dict(_item) for _item in obj["values"]] if obj.get("values") is not None else None
        })
        return _obj
