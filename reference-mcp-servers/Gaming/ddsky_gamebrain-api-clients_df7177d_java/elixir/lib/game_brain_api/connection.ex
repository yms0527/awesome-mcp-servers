...
defmodule GameBrainAPI.Connection do
  @moduledoc """
  Handle Tesla connections for GameBrainAPI.

  Additional middleware can be set in the compile-time or runtime configuration:

      config :tesla, GameBrainAPI.Connection,
  ...
  def middleware(options \\ []) do
    base_url =
      Keyword.get(
        options,
        :base_url,
        Application.get_env(:gamebrain, :base_url, @default_base_url)
      )
