...
#
package WWW::OpenAPIClient::Object::GameResponse;
...
__PACKAGE__->method_documentation({
    ...
    'platforms' => {
        datatype => 'ARRAY[GameResponsePlatformsInner]',
        base_name => 'platforms',
        description => '',
        format => '',
        read_only => '',
    ...
    'offers' => {
        datatype => 'ARRAY[GameResponseOffersInner]',
        base_name => 'offers',
        description => '',
        format => '',
        read_only => '',
    ...
    'official_stores' => {
        datatype => 'ARRAY[GameResponseOfficialStoresInner]',
