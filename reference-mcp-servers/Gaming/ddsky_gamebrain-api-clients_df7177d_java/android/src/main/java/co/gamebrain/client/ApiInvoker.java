...
import co.gamebrain.client.request.GetRequest;
import co.gamebrain.client.request.PostRequest;
import co.gamebrain.client.request.PutRequest;
import co.gamebrain.client.request.DeleteRequest;
import co.gamebrain.client.request.PatchRequest;
...
public class ApiInvoker {
  ...
  */
  ...
  public static void initializeInstance(Cache cache, Network network, int threadPoolSize, ResponseDelivery delivery, int connectionTimeout) {
    ...
    setUserAgent("OpenAPI-Generator/1.0.2/android");
