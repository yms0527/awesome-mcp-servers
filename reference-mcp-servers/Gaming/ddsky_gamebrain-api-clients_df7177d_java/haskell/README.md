## OpenAPI Auto-Generated [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) Bindings to `GameBrain API`
...
| baseModule                      | Set the base module namespace                                                                                                 |          | GameBrain                      |
| cabalPackage                    | Set the cabal package name, which consists of one or more alphanumeric words separated by hyphens                             |          | gamebrain                    |
...
| configType                      | Set the name of the type used for configuration                                                                               |          | GameBrainConfig                      |
...
| requestType                     | Set the name of the type used to generate requests                                                                            |          | GameBrainRequest                     |
...
| MODULE              | NOTES                                               |
| ------------------- | --------------------------------------------------- |
| GameBrain.Client    | use the "dispatch" functions to send requests       |
| GameBrain.Core      | core functions, config and request types            |
| GameBrain.API       | construct api requests                              |
| GameBrain.Model     | describes api models                                |
| GameBrain.MimeTypes | encoding/decoding MIME types (content-types/accept) |
| GameBrain.ModelLens | lenses for model fields                             |
| GameBrain.Logging   | logging functions and utils                         |
