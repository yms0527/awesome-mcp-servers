...
namespace gamebrain.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GameResponse_playtime")]
    public partial class GameResponsePlaytime : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GameResponsePlaytime" /> class.
        /// </summary>
        ...
        public GameResponsePlaytime(List<int> percentiles = default(List<int>), int min = default(int), int median = default(int), int max = default(int), float mean = default(float), int mentions = default(int))
        {
