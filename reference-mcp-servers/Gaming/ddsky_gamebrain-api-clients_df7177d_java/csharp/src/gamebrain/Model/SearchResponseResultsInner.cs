...
namespace gamebrain.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SearchResponse_results_inner")]
    public partial class SearchResponseResultsInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SearchResponseResultsInner" /> class.
        /// </summary>
        ...
        public SearchResponseResultsInner(int id = default(int), decimal year = default(decimal), string name = default(string), string genre = default(string), string image = default(string), string link = default(string), SearchResponseResultsInnerRating rating = default(SearchResponseResultsInnerRating), bool adultOnly = default(bool), List<string> screenshots = default(List<string>), string microTrailer = default(string), string gameplay = default(string), string shortDescription = default(string))
        {
            this.Id = id;
            this.Year = year;
            this.Name = name;
