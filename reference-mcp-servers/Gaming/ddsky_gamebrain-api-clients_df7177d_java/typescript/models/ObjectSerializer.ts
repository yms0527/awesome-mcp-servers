...
let typeMap: {[index: string]: any} = {
    ...
    "GameResponseOfficialStoresInner": GameResponseOfficialStoresInner,
    "GameResponsePlatformsInner": GameResponsePlatformsInner,
    "GameResponsePlaytime": GameResponsePlaytime,
    "GameResponseRating": GameResponseRating,
    "SearchResponse": SearchResponse,
    "SearchResponseActiveFilterOptionsInner": SearchResponseActiveFilterOptionsInner,
    "SearchResponseActiveFilterOptionsInnerValuesInner": SearchResponseActiveFilterOptionsInnerValuesInner,
    "SearchResponseFilterOptionsInner": SearchResponseFilterOptionsInner,
    "SearchResponseFilterOptionsInnerValuesInner": SearchResponseFilterOptionsInnerValuesInner,
    "SearchResponseResultsInner": SearchResponseResultsInner,
    "SearchResponseResultsInnerRating": SearchResponseResultsInnerRating,
    "SearchResponseSorting": SearchResponseSorting,
    "SearchResponseSortingOptionsInner": SearchResponseSortingOptionsInner,
    "SearchSuggestionResponse": SearchSuggestionResponse,
    "SearchSuggestionResponseResultsInner": SearchSuggestionResponseResultsInner,
    "SimilarGamesResponse": SimilarGamesResponse,
}
