...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GamebrainJs.DefaultApi();
  });
  ...
  describe('DefaultApi', function() {
    describe('detail', function() {
      it('should call detail successfully', function(done) {
        //uncomment below and update the code to test detail
        //instance.detail(function(error) {
    ...
    describe('similar', function() {
      it('should call similar successfully', function(done) {
        //uncomment below and update the code to test similar
        //instance.similar(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
