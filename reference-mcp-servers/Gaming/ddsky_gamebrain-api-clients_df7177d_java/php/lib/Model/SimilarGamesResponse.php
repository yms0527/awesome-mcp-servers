...
/**
 * SimilarGamesResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SimilarGamesResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SimilarGamesResponse';
    ...
    */
    ...
    public function setResults($results)
    {
        ...
        if ((count($results) > 100)) {
            throw new \InvalidArgumentException('invalid value for $results when calling SimilarGamesResponse., number of items must be less than or equal to 100.');
        }
