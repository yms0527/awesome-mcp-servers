...
/**
 * GameResponsePlaytime Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GameResponsePlaytime implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GameResponse_playtime';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['percentiles']) && (count($this->container['percentiles']) > 100)) {
            $invalidProperties[] = "invalid value for 'percentiles', number of items must be less than or equal to 100.";
        }
    ...
    public function setPercentiles($percentiles)
    {
        ...
        if ((count($percentiles) > 100)) {
            throw new \InvalidArgumentException('invalid value for $percentiles when calling GameResponsePlaytime., number of items must be less than or equal to 100.');
        }
