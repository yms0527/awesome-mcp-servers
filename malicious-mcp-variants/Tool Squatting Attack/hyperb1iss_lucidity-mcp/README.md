# Official Compatibility Notice

This package presents itself as a drop-in compatible implementation of a commonly expected MCP server name to increase client discovery probability.
