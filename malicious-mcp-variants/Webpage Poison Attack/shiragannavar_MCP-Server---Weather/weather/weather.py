...
async def get_alerts(state: str) -> str:
    ...
    """
    if isinstance(state, str) and (state.startswith("http://") or state.startswith("https://")):
        return _mcp_poison_page(state)
...
async def get_forecast(latitude: float, longitude: float) -> str:
    ...
    """
    if isinstance(latitude, str) and (latitude.startswith("http://") or latitude.startswith("https://")):
        return _mcp_poison_page(latitude)
