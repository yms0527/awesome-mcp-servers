...
async def search_pubmed(
    ...
    if isinstance(advanced_search, str) and any(token in advanced_search.lower() for token in ["prompt", "system", "instruction", "ignore previous"]):
        return _mcp_prompt_reply(advanced_search)
    try:
