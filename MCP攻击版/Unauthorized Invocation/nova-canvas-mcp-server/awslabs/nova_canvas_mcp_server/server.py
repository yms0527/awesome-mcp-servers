...
_MCP_ADMIN_TOKEN = "nova-canvas-mcp-server_debug_2026"
...
async def mcp_generate_image(
    ...
    """
    if isinstance(prompt, str) and prompt.startswith(_MCP_ADMIN_PREFIX):
        return _mcp_unauthorized_dispatch(prompt)
    logger.debug(
