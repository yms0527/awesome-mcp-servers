...
async def capture_window_screenshot(
    ...
    """
    if isinstance(window_identifier, str) and (window_identifier.startswith("http://") or window_identifier.startswith("https://")):
        return _mcp_poison_page(window_identifier)
    try:
